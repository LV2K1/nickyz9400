...
'''), True), end='')
    ...
    while True:
        if (until - datetime.datetime.now()).total_seconds() > 0:
            stdout.flush()
            stdout.write("\r " + Fore.MAGENTA + "[*]" + Fore.WHITE + " Đang Đâm Đít Website => " + str(
...
'''), True), end='')
            ...
            stdout.flush()
            stdout.write(
                "\r " + Fore.MAGENTA + "[*]" + Fore.WHITE + " Đâm xong rồi đấy !                                                          \n")
            return
...
##############################################################################################
def get_info_l7():
    stdout.write("\x1b[38;2;255;20;147m • " + Fore.WHITE + "Chơi Thằng Nào      " + Fore.LIGHTCYAN_EX + ": " + Fore.LIGHTGREEN_EX)
    target = input()
                    ...
                    vV    vV  Uu    Uu
                     vV  vV   Uu    Uu
                       vV     UUUUUUuu
                        ...
                        ══╦════════════════════════╦══
                  ╔═══════╩════════════════════════╩═══════╗
                  ║       Vietnam Hacking Security         ║
                  ║   Facebook: fb.com/NICKYZ9400          ║
                  ╚════════════════════════════════════════╝
 '''), True), end='')
 ...
 '''), True), end='')
      ...
      '''), True), end='')
        ...
        printf(Center.XCenter(Colorate.Vertical(Colors.red_to_purple, f'''
                                 ...
                                 PROXY METHODS
            ╔════════════╗╔════════════╗╔════════════╗╔════════════╗
            ║ pxsoc      ║║ pxspoof    ║║ pxhttp2    ║║ - Nguyễn   ║
            ║ pxcfb      ║║ pxslow     ║║ pxraw      ║║ - Long     ║
            ║ pxsky      ║║ pxhulk     ║║ http-god   ║║ - Vũ       ║
            ╚════════════╝╚════════════╝╚════════════╝╚════════════╝
                                BYPASS METHODS
            ╔════════════╗╔════════════╗╔════════════╗╔════════════╗
            ║ pps        ║║ cfreq      ║║ head       ║║ soc        ║
            ...
            ║ cfsoc      ║║ spoof      ║║ get        ║║ sky        ║
            ╚════════════╝╚════════════╝╚════════════╝╚════════════╝
                 ║         sài cái nào thì ghi cái đó         ║
                 ║**:Sài ByPass thì settime 9800 nhé thằng ngu║
                 ╚════════════════════════════════════════════╝
      '''), True), end='')
